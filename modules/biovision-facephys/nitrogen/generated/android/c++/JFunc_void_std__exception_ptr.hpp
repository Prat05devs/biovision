...
namespace margelo::nitro::biovision::facephys {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/biovision/facephys/Func_void_std__exception_ptr;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/biovision/facephys/Func_void_std__exception_ptr_cxx;";
