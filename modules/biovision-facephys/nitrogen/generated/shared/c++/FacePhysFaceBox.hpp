...
namespace margelo::nitro::biovision::facephys {
  ...
  /**
   * A struct which can be represented as a JavaScript object (FacePhysFaceBox).
   */
  struct FacePhysFaceBox final {
  public:
  ...
  public:
    FacePhysFaceBox() = default;
    explicit FacePhysFaceBox(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const FacePhysFaceBox& lhs, const FacePhysFaceBox& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ FacePhysFaceBox <> JS FacePhysFaceBox (object)
  template <>
  struct JSIConverter<margelo::nitro::biovision::facephys::FacePhysFaceBox> final {
    static inline margelo::nitro::biovision::facephys::FacePhysFaceBox fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::biovision::facephys::FacePhysFaceBox(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::biovision::facephys::FacePhysFaceBox& arg) {
